...
for (dep_var in dependent_vars) {
  for (predictor in predictors) {
    ...
    if (predictor == "FilterCoffee_mean") {
      # Test FilterCoffee_mean interactions with APOE_all and family_history_AD for both factor=0 and factor=1
      ...
      # Test StandTea_mean interaction with APOE_all for both factor=0 and factor=1
      interaction_terms <- c("StandTea_mean * APOE_all")
