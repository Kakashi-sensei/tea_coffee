...
ggplot(df, aes(x = Dependent_Variable, y = Estimate, fill = Test_Variable)) +
  ...
  geom_errorbar(aes(ymin = Error_Lower, ymax = Error_Upper), 
                width = 0.2, color = "black", position = position_dodge(width = 0.8)) +  # Error bars in black
  ...
  theme_minimal() +
  theme(
    text = element_text(size = 48, color = "black", family = "Calibri"),
    axis.title = element_text(size = 60, color = "black", family = "Calibri"),
    plot.title = element_text(size = 60, hjust = 0.5),
    axis.text = element_text(size = 60),
...
ggsave("C:\\Users\\timothy\\OneDrive\\Documents\\ISU\\food_project\\output\\tea_coffee\\results\\maineffect_plot_black_error_legend.tiff",
